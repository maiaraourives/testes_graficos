...
class FlChartOitoView extends StatefulWidget {
  const FlChartOitoView({super.key});

  @override
  State<StatefulWidget> createState() => FlChartOitoViewState();
}

class FlChartOitoViewState extends State {
  int touchedIndex = -1;
